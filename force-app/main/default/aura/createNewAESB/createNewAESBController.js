({
    ...
    checkRefresh : function(c,e,h){
        c.set('v.getDataRefresh',!c.get('v.getDataRefresh'));
    },
    checkActive : function(c,e,h){
        c.set('v.getIsActive',!c.get('v.getIsActive'));
    },
    checkAccom : function(c,e,h){
        c.set('v.getIsAccom',!c.get('v.getIsAccom'));
    },
