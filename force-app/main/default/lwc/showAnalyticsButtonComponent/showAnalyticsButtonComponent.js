...
export default class ShowAnalyticsButtonComponent extends LightningElement {
    ...
    connectedCallback() {
        ...
        console.log('typeOfanalytics '+this.typeOfanalytics);
            ...
            let timeDurationToBeSet = this.template.querySelectorAll(".typeList");
            console.log('timeDurationToBeSet '+timeDurationToBeSet);
           // console.log('timeDurationToBeSet '+JSON.stringify(timeDurationToBeSet));
   ...
   /* @wire(gettingAllChannels, {timeDuration : 'Day'}) 
